...
import Mask from "./2024-09-28-Drawing-Impossible-Figure-with-Siv3D/mask.png"
import Back from "./2024-09-28-Drawing-Impossible-Figure-with-Siv3D/back.png"
import Whole from "./2024-09-28-Drawing-Impossible-Figure-with-Siv3D/whole.png"
import Result from "./2024-09-28-Drawing-Impossible-Figure-with-Siv3D/result.png"
import Flow from "./2024-09-28-Drawing-Impossible-Figure-with-Siv3D/flow.png"
import Gif from "./2024-09-28-Drawing-Impossible-Figure-with-Siv3D/result.gif"

## 不可能図形とは

こういうやつ。
<ul style="display: flex;">
<li><img src="https://upload.wikimedia.org/wikipedia/commons/8/81/Impossible_cube_illusion_angle.svg" height="200" width="200" alt="ある角度から見ると、幾何学の法則を無視しているように見える立方体 (wikipedia)"></img></li>
<li><img src="https://upload.wikimedia.org/wikipedia/commons/3/34/Impossible_objects.svg" height="200" width="200" alt="2つの有名な不可能図形。ペンローズの三角形とブリヴェット（悪魔のフォーク）(wikipedia)"></img></li>
<li><img src="https://upload.wikimedia.org/wikipedia/commons/3/34/Impossible_staircase.svg" height="200" width="200" alt="ペンローズの階段 (wikipedia)"></img></li>
</ul>
...
<figure>
 <Image src={Whole} width="200" height="200" />
 <figcaption> 全体を描画したレンダーテクスチャ </figcaption>
</figure>
...
<figure>
 <Image src={Back} width="200" height="200" />
 <figcaption> 手前の辺以外を描画したレンダーテクスチャ </figcaption>
</figure>
...
<figure>
 <Image src={Mask} width="200" height="200" />
 <figcaption> マスク用のレンダーテクスチャ </figcaption>
</figure>

そしてこれらをこのように合成する。

<figure>
 <Image src={Flow} width="200" height="200" />
 <figcaption> レンダーテクスチャの合成フロー </figcaption>
</figure>

すると不可能図形が描画されるのだ！

<figure>
 <Image src={Result} width="200" height="200" />
 <figcaption> 不可能図形の描画結果 </figcaption>
</figure>
...
<figure>
 <Image src={Gif} width="200" height="200" />
 <figcaption> 不可能図形の描画結果の動画（gif） </figcaption>
</figure>
