...
<li><img src="https://upload.wikimedia.org/wikipedia/commons/8/81/Impossible_cube_illusion_angle.svg" height="200" width="200" alt="ある角度から見ると、幾何学の法則を無視しているように見える立方体 (wikipedia)"></li>
<li><img src="https://upload.wikimedia.org/wikipedia/commons/3/34/Impossible_objects.svg" height="200" width="200" alt="2つの有名な不可能図形。ペンローズの三角形とブリヴェット（悪魔のフォーク）(wikipedia)"></li>
<li><img src="https://upload.wikimedia.org/wikipedia/commons/3/34/Impossible_staircase.svg" height="200" width="200" alt="ペンローズの階段 (wikipedia)"></li>
</ul>
