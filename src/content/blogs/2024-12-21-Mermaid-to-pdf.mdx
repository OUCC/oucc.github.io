...
出来上がったpdf
(1ページ目)
<Image src={headless1} alt="" width="600px" style="padding: 10px; margin-bottom: 10px; border: 1px solid #333333;" />
(2ページ目)
<Image src={headless2} alt="" width="600px" style="padding: 10px; margin-bottom: 10px; border: 1px solid #333333;" />
